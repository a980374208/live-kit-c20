...
void MeetingMainWindow::onCardClicked(ActionCardType type) {
	if (type == ActionCardType::JoinMeeting) {
		...
		cfg.token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..SNJCwsbVdeb6ZNe_YbYXaHI_TKpflKlDSRtSDl-kBiI";
